...
$sql="SELECT * FROM enrolled WHERE type='SPECIAL'";
...
th {
  ...
  <body>
    <h1>Supplimentary Students</h1>
    <div style="overflow-x:auto;">
    <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%" padding="3px">
      <tr>
        <th>id</th>
        <th>RegNo</th>
        <th>Name</th>
